...
BOT_TOKEN = environ.get('BOT_TOKEN', '6557517336:AAE0kJGwYdVbphnWlrGzv17toLj-72Mf6Kg')
# Bot settings
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://Bot:Bot@cluster0.jcdvs4s.mongodb.net/?retryWrites=true&w=majority")
...
SHORTLINK_API = environ.get('SHORTLINK_API', 'ffebcc17c13c132d75bdbe0a840e14e34daed9f8')
IS_SHORTLINK = is_enabled((environ.get('IS_SHORTLINK', 'True')), True)
DELETE_CHANNELS = [int(dch) if id_pattern.search(dch) else dch for dch in environ.get('DELETE_CHANNELS', '0').split()]
MAX_B_TN = environ.get("MAX_B_TN", "5")
MAX_BTN = is_enabled((environ.get('MAX_BTN', "True")), True)
PORT = environ.get("PORT", "8080")
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/+bDOmmqJXhDs2OTA1')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/+jWx_OwHfwwJiMmNl')
MSG_ALRT = environ.get('MSG_ALRT', '😍😍 Piracy is crime 😍😍')
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1001879756964'))
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', '😍😍 Piracy is crime 😍😍')
